...
import { updateThueGame } from "../../../services/thueGameLienHeAPI";
import { data } from "jquery";
const UpdateThueGame = ({openUpdateThueGame, setOpenUpdateThueGame, fetchOneThueGames, dataThueGame}) => {
    ...
    const handleCreateThueGame = async (values) => {
        ...
        setIsSubmit(true)
        const res = await updateThueGame(_id, text)
        if(res && res.data) {
